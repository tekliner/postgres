...
PACKAGE_NAME=github.com/tekliner/apimachinery
...
docker run --rm -ti -u $(id -u):$(id -g) \
  ...
  -w "$DOCKER_REPO_ROOT" \
  appscode/gengo:release-1.12 "$DOCKER_CODEGEN_PKG"/generate-groups.sh "deepcopy,client,informer,lister" \
  github.com/tekliner/apimachinery/client \
