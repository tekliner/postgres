...
import (
	...
	authorizationinstall "github.com/tekliner/apimachinery/apis/authorization/install"
	authorizationv1alpha1 "github.com/tekliner/apimachinery/apis/authorization/v1alpha1"
	cataloginstall "github.com/tekliner/apimachinery/apis/catalog/install"
	catalogv1alpha1 "github.com/tekliner/apimachinery/apis/catalog/v1alpha1"
	kubedbinstall "github.com/tekliner/apimachinery/apis/kubedb/install"
...
func generateCRDDefinitions() {
	...
	filename := gort.GOPath() + "/src/github.com/tekliner/apimachinery/apis/kubedb/v1alpha1/crds.yaml"
	os.Remove(filename)

	err := os.MkdirAll(filepath.Join(gort.GOPath(), "/src/github.com/tekliner/apimachinery/api/crds"), 0755)
	if err != nil {
		log.Fatal(err)
	}
	...
	for _, crd := range crds {
		filename := filepath.Join(gort.GOPath(), "/src/github.com/tekliner/apimachinery/api/crds", crd.Spec.Names.Singular+".yaml")
...
func generateSwaggerJson() {
	...
	filename := gort.GOPath() + "/src/github.com/tekliner/apimachinery/api/openapi-spec/swagger.json"
